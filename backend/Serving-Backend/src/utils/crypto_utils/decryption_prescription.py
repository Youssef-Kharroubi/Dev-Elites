...
def fetch_and_decrypt_prescriptions(database_name: str = "MedicalFormsDB", container_name: str = "prescriptions", key_path: str = "../../models/fernet.key"):
    ...
    print(f"\nFetching and decrypting documents from '{container_name}'...")
...
#code call
fetch_and_decrypt_prescriptions()
